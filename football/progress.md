...
- Synchronized `GAME_VERSION`, all 15 Football asset query strings, the Football registry descriptor, and `version.json` to `1.33.1`; unrelated games remain unchanged.
